<?php
// Stratrix Technologies - Form Submission Handler (Native PHP mail())
...
$recipient = 'info@stratrixtechnologies.com';        // ← Your receiving email
...
<div class='container'>
    ...
    <div class='footer'>
        Sent via Stratrix Technologies Website • " . date('F j, Y, g:i a') . "<br>
...
$headers .= "From: Stratrix Technologies Website <info@stratrixtechnologies.com>\r\n";
